...
def process_log_file(cur, filepath):
    """
    Reads in the File into DataFrame
    
    Filters using NextSong 
    
    Converts into timestamp 
    
    Extract features from TimeStamp
    
    Inserts Data into Tables time, user, songs, songplays
    
    Parameters
    ----------
    cur : Database Cursor Object
        Run Qurries Using this Cursor on the Database
